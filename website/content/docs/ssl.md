...
Local development uses `<VPS_DEPLOYER_SSL_DIR>/<project>/` and validates PEM data with OpenSSL under the local user. Production requires the updated 0.7.0 helper; update the installation before using these commands.
